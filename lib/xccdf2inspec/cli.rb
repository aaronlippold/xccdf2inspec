...
class MyCLI < Thor
  ...
  option :replace_tags, require: false, aliases: '-t'
  ...
  def help
    ...
    puts "\t-s --replace-tags array : A comma seperated list to replace tags with a $ if found in a group rules description tag"
